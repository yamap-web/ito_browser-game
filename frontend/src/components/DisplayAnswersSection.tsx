        ...
        >
          {(provided) => (
            <ul
              ...
              className="flex flex-col-reverse lg:flex-row items-center justify-center w-full my-6"
            >
              <li className="badge badge-outline border-2 font-bold mt-2 lg:mt-0">
                1
              </li>
              ...
              <li className="badge badge-outline border-2 font-bold lg:ml-2">
                100
              </li>
            </ul>
          )}
